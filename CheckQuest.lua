...
function CheckLevel()
    ...
    if _G.Autolevel and (Vector3.new(921.12365722656, 125.9839553833, 33088.328125) - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
    ...
    elseif Lv == 2575 or Lv <= 2600 or _G.SelectMonster == "Skull Slayer" then
    _G.Ms = "Skull Slayer"
    _G.NameQuest = "TikiQuest3"
    _G.QuestLv = 2
